...
# removing item. Remove when item property meets one of the conditions Title or version, version might be either 2 or 3
target_list.recycle_item_by_property({"Title": "my_title",
                                      "version": ["2", "3"]}, or_filter=True)

# remove item when both conditions meet. Title is my_title and build_date is either "2020-11-17" or "2020-11-18"
target_list.recycle_item_by_property({"Title": "my_title",
